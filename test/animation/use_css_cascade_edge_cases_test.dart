...
void main() {
  group('CSS Cascade Through Shadow Boundary Edge Cases', () {
    ...
    testWidgets(
      'CSS ID selector matches element inside use shadow tree',
    ...
    testWidgets(
      'CSS class selector matches element inside use shadow tree',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'descendant combinator selector stops at shadow boundary',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'child combinator selector stops at shadow boundary',
      (WidgetTester tester) async {
  ...
  group('Nested Use-Within-Use Inheritance Edge Cases', () {
    ...
    testWidgets(
      'fill inheritance through 2 levels of nested use',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'fill inheritance through 3 levels of nested use',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'inner use can override outer use inherited value',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'stroke-width inherits through nested use',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
  ...
  group('Coordinate Transform Stacking Edge Cases', () {
    ...
    testWidgets(
      '3 levels of use x/y coordinates stack correctly',
      (WidgetTester tester) async {
        const svgXml = '''
    ...
    testWidgets(
      'nested use transform attributes compose correctly',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 200 200">
          <defs>
    ...
    testWidgets(
      'use with rotate transform applies correctly',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 200 200">
          <defs>
    ...
    testWidgets(
      '4 levels of nested use renders without crash',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 200 200">
          <defs>
  ...
  group('Event Retargeting Edge Cases', () {
    ...
    testWidgets(
      'click on use shadow content triggers use element event',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'nested use event retargets to outermost use',
      (WidgetTester tester) async {
        const svgXml = '''
  ...
  group('Additional CSS Cascade Edge Cases', () {
    ...
    testWidgets(
      '!important on use element overrides referenced content',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'CSS class styling works through use boundary',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <style>
    ...
    testWidgets(
      'use element inherits fill from parent group',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
