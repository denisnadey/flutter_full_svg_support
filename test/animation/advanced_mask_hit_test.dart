...
void main() {
  group('Mask Edge Cases - Circular References', () {
    testWidgets(
      'circular mask reference handled gracefully (no crash)',
    ...
    testWidgets(
      'self-referencing mask handled gracefully',
      (WidgetTester tester) async {
  ...
  group('Mask Edge Cases - Text Content', () {
    testWidgets(
      'mask with text content renders correctly',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
  ...
  group('Mask Edge Cases - Multiple Shapes', () {
    ...
    testWidgets(
      'mask with different shapes (rect, circle, path)',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
  ...
  group('Mask Edge Cases - Non-Uniform ViewBox', () {
    testWidgets(
      'mask on SVG with non-uniform viewBox (wide)',
      (WidgetTester tester) async {
        const svgXml = '''
    ...
    testWidgets(
      'mask on SVG with non-uniform viewBox (tall)',
      (WidgetTester tester) async {
        const svgXml = '''
  ...
  group('Mask Edge Cases - Deep Nesting', () {
    testWidgets(
      'deeply nested mask structure (3 levels)',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'mask with deeply nested groups',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
  ...
  group('Mask Edge Cases - Alpha Gradient', () {
    testWidgets(
      'alpha mask with linear gradient opacity',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
    ...
    testWidgets(
      'alpha mask with radial gradient opacity',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
  ...
  group('Mask Edge Cases - Use Element', () {
    ...
    testWidgets(
      'mask with symbol use reference',
      (WidgetTester tester) async {
        const svgXml = '''
        <svg viewBox="0 0 100 100">
          <defs>
