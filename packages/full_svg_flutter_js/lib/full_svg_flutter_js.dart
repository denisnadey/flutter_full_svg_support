...
import 'package:full_svg_flutter_js/javascript_runtime.dart';
import 'package:full_svg_flutter_js/javascriptcore/jscore_runtime.dart';
...
//import 'package:full_svg_flutter_js/quickjs-sync-server/quickjs_oasis_jsbridge.dart';
//import 'package:full_svg_flutter_js/quickjs/quickjs_runtime.dart';
...
JavascriptRuntime getJavascriptRuntime({
  // Kept for upstream API compatibility — has no effect in this fork.
  // We always use the bundled quickjs-ng on every platform.
  bool forceJavascriptCoreOnAndroid = false,
  bool xhr = true,
  Map<String, dynamic>? extraArgs = const {},
}) {
  final int stackSize = extraArgs?['stackSize'] ?? 1024 * 1024;
  final JavascriptRuntime runtime = QuickJsRuntime2(stackSize: stackSize);
...
MethodChannel _methodChannel = const MethodChannel('io.full_svg.flutter_js')
